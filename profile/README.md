...
- **Patient Portal** - Easy queue registration and real-time status updates
- **Admin Dashboard** - Hospital staff management and queue oversight
- **ML-Powered Predictions** - Intelligent wait time estimation
